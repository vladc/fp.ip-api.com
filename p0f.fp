...
label = s:unix:Linux:4x
sig   = *:64:0:*:mss*20,9:mss,sok,ts,nop,ws:df,id+:0
sig   = *:64:0:*:mss*20,8:mss,sok,ts,nop,ws:df,id+:0
...
sig   = *:Host,User-Agent,Accept=[,*/*;q=],?Accept-Language=[;q=],Accept-Encoding=[gzip, deflate],?DNT=[1],?Referer,?Origin,Connection=[keep-alive]:Accept-Charset,Keep-Alive:Firefox/
...
sig   = *:Host,User-Agent,Accept=[*/*],?Accept-Language=[;q=],Accept-Encoding=[gzip, deflate],?Referer,?Origin,?DNT=[1],Connection=[keep-alive]:Accept-Charset,Keep-Alive:Firefox/

label = s:!:Firefox:60.x or newer
sys   = Windows,@unix
sig   = *:Host,User-Agent,Accept=[*/*],Accept-Language=[;q=],Accept-Encoding=[gzip, deflate],Origin,?DNT=[1],Connection=[keep-alive],?Referer,?Upgrade-Insecure-Requests=[1],?Cache-Control:Accept-Charset,Keep-Alive:Firefox/
sig   = *:User-Agent,Accept=[*/*],Accept-Language,Host:Connection,Accept-Encoding,Accept-Charset,Keep-Alive:Firefox/
...
label = s:!:MSIE:>=8
sys   = Windows
sig   = 1:Accept=[*/*],?Referer,?Accept-Language,?Origin,Accept-Encoding=[gzip, deflate],User-Agent=[Trident],Host,?DNT=[1],Connection=[Keep-Alive],?Cache-Control:Accept-Charset,Keep-Alive:Trident/

label = s:!:Microsoft Edge:>=25
sys   = Windows
sig   = 1:Accept=[*/*],?Referer,?Accept-Language,?Origin,Accept-Encoding=[gzip, deflate],User-Agent=[Edge],Host,?DNT=[1],Connection=[Keep-Alive],?Cache-Control:Accept-Charset,Keep-Alive:Edge/

label = s:!:Microsoft Edge (Chrome):>=18
sys   = Windows
sig   = 1:?Cache-Control,Accept,Accept-Language,?Upgrade-Insecure-Requests=[1],User-Agent,Accept-Encoding=[gzip, deflate],Host,Connection=[Keep-Alive]:Accept-Charset,Keep-Alive:Edge/
sig   = 1:?Origin,?Referer,User-Agent,?Cache-Control,Accept=[*/*],Accept-Language,Accept-Encoding=[gzip, deflate],Host,Connection=[Keep-Alive]:Accept-Charset,Keep-Alive:Edge/
...
sys   = Windows,@unix
sig   = 1:Host,Connection=[keep-alive],?Cache-Control,Upgrade-Insecure-Requests=[1],User-Agent,Accept=[*/*],Accept-Encoding=[gzip, deflate, sdch],Accept-Language:Accept-Charset,Keep-Alive: Chrom

label = s:!:Chrome:59.x or newer
sys   = Windows,@unix
sig   = 1:Host,Connection=[keep-alive],?Cache-Control,Upgrade-Insecure-Requests=[1],User-Agent,Accept=[*/*],Accept-Encoding=[gzip, deflate],Accept-Language:Accept-Charset,Keep-Alive: Chrom
sig   = 1:Host,Connection=[keep-alive],User-Agent,?Origin,Accept=[*/*],?Referer,Accept-Encoding=[gzip, deflate],Accept-Language:Accept-Charset,Keep-Alive: Chrom
...
label = s:!:Safari Android:5 or newer
sys   = Mac OS X
sig   = 1:Accept-Language,User-Agent,Host,Connection=[Keep-Alive],Accept-Encoding=[gzip]:Accept,Accept-Charset,Keep-Alive:Mobile Safari/
...
; new stuff
label = s:!:Android:generic Java client
sys   = @unix,Windows
sig   = 1:Content-Type,Accept=[application/x-stream],Accept-Encoding=[gzip],User-Agent,Connection=[Keep-Alive],Keep-Alive=[5000],Http-version=[HTTP/1.1],Host:Accept-Language,Accept-Charset:Java

label = s:!:wget:
sys   = @unix,Windows
sig   = *:User-Agent,Accept=[*/*],Host,Connection=[Keep-Alive]:Accept-Language,Accept-Charset:Wget/
...
label = s:!:Wordpress:
sys   = @unix,Windows
sig   = 1:Host,User-Agent,Accept=[*/*],Accept-Encoding=[deflate, gzip],?Referer,Connection=[close]:Accept-Language,Accept-Charset,Keep-Alive:Wordpress/

label = s:!:curl:
sys   = @unix,Windows
sig   = *:Host,User-Agent,Accept=[*/*]:Connection,Accept-Encoding,Accept-Language,Accept-Charset:curl/
sig   = *:User-Agent,Host,Accept=[*/*]:Connection,Accept-Encoding,Accept-Language,Accept-Charset,Keep-Alive:curl/

label = s:!:iOS/Mac OS X:generic app
sys   = Mac OS X
sig   = 1:Host,Accept,Accept-Language,Connection=[keep-alive],Accept-Encoding=[gzip, deflate],User-Agent:Accept-Charset,Keep-Alive:
sig   = 1:Host,Accept,Accept-Language,Accept-Encoding=[gzip],User-Agent,?X-Forwarded-For,?If-Modified-Since,?Cache-Control,Connection=[Keep-Alive]:Accept-Charset,Keep-Alive:
sig   = 1:Host,Accept,Accept-Language,Connection=[keep-alive],Accept-Encoding=[gzip],User-Agent:Accept-Charset,Keep-Alive:
sig   = 1:Connection=[keep-alive],Host,Accept=[*/*],Accept-Language=[en-us],Accept-Encoding=[gzip, deflate],User-Agent:Accept-Charset,Keep-Alive:


label = s:!:Android:Dalvik generic app
sys   = Linux
sig   = 1:User-Agent,Host,Connection=[Keep-Alive],Accept-Encoding=[gzip]:Accept,Accept-Language,Accept-Charset,Keep-Alive:
sig   = 1:Content-Type,Accept,User-Agent,Host,Connection=[Keep-Alive],Accept-Encoding=[gzip]:Accept-Language,Accept-Charset,Keep-Alive:
sig   = 1:Accept-Encoding=[identity],User-Agent,Host,Connection=[Keep-Alive]:Accept,Accept-Language,Accept-Charset,Keep-Alive:
sig   = 1:?If-Modified-Since,User-Agent,Accept-Encoding=[gzip],Host,?Cache-Control,Connection=[keep-alive]:Accept,Accept-Language,Accept-Charset,Keep-Alive:


label = s:!:Apache:Java HttpClient
sys   = @unix,Windows
sig   = 1:Host,Connection=[Keep-Alive],User-Agent:Accept,Accept-Encoding,Accept-Language,Accept-Charset,Keep-Alive:Apache
...
label = s:!:Python:requests
sys   = @unix,Windows
sig   = 1:Host,User-Agent,Accept-Encoding=[gzip, deflate],Accept=[*/*]:Connection,Accept-Language,Accept-Charset,Keep-Alive:python-requests/

label = s:!:okhttp:
sys   = @unix,Windows
sig   = 1:Host,Connection=[Keep-Alive],Accept-Encoding=[gzip],User-Agent,?If-Modified-Since:Accept,Accept-Language,Accept-Charset,Keep-Alive:okhttp/
sig   = 1:?If-Modified-Since,Accept-Encoding=[gzip],User-Agent,Host,?Cache-Control,?Connection=[keep-alive]:Accept,Accept-Language,Accept-Charset,Keep-Alive:okhttp/
sig   = 1:Connection=[Keep-Alive],Host,Accept-Encoding=[gzip],User-Agent:Accept,Accept-Language,Accept-Charset,Keep-Alive:okhttp/
sig   = 1:Host,Accept-Encoding=[gzip],User-Agent,?X-Forwarded-For,?Via:Connection,Accept,Accept-Language,Accept-Charset,Keep-Alive:okhttp/
...
label = s:!:Go:http-client
sys   = @unix
sig   = 1:Host,User-Agent,?Connection,Accept-Encoding=[gzip]:Accept,Accept-Language,Accept-Charset,Keep-Alive:Go-http-client/
sig   = 1:Host,User-Agent,Accept-Encoding=[gzip],?Connection=[close]:Accept,Accept-Language,Accept-Charset,Keep-Alive:Go-http-client/
